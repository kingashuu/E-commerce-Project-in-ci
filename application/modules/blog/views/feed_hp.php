			...
			<div class="col-md-4 col-sm-6">
				<div class="single-blog">
					<div class="blog-image">
						<a href="<?= $blog_url?>" >
							<img alt="<?php echo $row->page_title; ?>" style="height: 190px; width: 370px;" class="img-responsive" src="<?php echo $thumbnail_path;?>">
						</a>
					</div>
					<div class="blog-content pb-20 text-center">
						<div class="date-added mb-20 pt-20"><i class="zmdi zmdi-time mr-10"></i><?= $date_published?></div>
						...
						<div class="post-info-author mt-30">
							<span class="author mr-20">
								...
								By
								<a href="<?php echo base_url();?>#" title="Posts by admin"> <?= $row->author?></a>
							</span>
