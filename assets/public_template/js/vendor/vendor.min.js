				...
				this.each(function() {
					...
					(A.VBclose = function() {
						...
						D.on('click', function(u) {
							...
							return (
								...
								c.css({ color: H.titleColor, 'background-color': H.titleBackground }),
								e('.vbox-close').css({ color: H.closeColor, 'background-color': H.closeBackground }),
					...
					function J(e) {
						if (!0 === N) {
							...
							(Y = X - z) < 0 && !0 === _ && ((s = w), (i = !0)),
								Y > 0 && !0 === B && ((s = C), (i = !0)),
								Math.abs(Y) >= q && !0 === i ? Q(s) : d.css({ 'margin-left': 0, 'margin-right': 0 });
						}
					}
